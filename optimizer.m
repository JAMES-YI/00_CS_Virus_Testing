...
methods
    %%
    function Optimizer = optimizer(inData,gnrParams)
        
        Optimizer.inData = inData;
        Optimizer.gnrParams = gnrParams;
        
    end
    
    %% 
    function xEst = L1_min(Optimizer,slvParams)
        ...
        A = Optimizer.inData.A;
        poolVal = Optimizer.inData.poolVal;
    ...
    %% 
    function xEst = MismatchRatio_SUCCMIN(Optimizer,slvParams)
    ...
    %% 
    function xEst = Exhaust(Optimizer,slvParams)
        
    end
    
    %% 
    function xEst = Obo_mm(optimizer,slvParmas)
